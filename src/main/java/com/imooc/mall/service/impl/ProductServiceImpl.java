...
public class ProductServiceImpl implements ProductService {
    ...
    public PageInfo list(ProductListReq productListReq) {
        ...
        //目录处理：如果查某个目录下的商品，不仅是需要查出该目录下的，还要把所有目录的所有商品
        // 都查出来，所以要拿到一个目录id的List
    ...
    private void getCategoryIds( List<CategoryVO>
     categoryVOList,ArrayList<Integer> categoryIds){
